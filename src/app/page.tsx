...
const page: React.FC = () => {
  ...
  return (
    <Box className="mt-80" sx={{ backgroundColor: "#0a182d", }}>
      <Typography variant='h4' sx={{ color: "red", padding: "10px 20px", textTransform: "uppercase" }}>Popular</Typography>
            ...
            return (
              <Grid key={movie.id} item xs={12} sm={12} md={3} lg={2} xl={2} sx={{ padding: "10px 20px" ,cursor:"pointer"}}>
                <Grid sx={{ border: "2px solid gray", color: "white", textAlign: "center", padding: "10px 10px" }} height={400}>
                  <Image src="/banner.jpg" alt="" height={250} width={300} />
                  ...
                  <Typography sx={{fontSize:"14px", color:"white",textAlign:"right",paddingTop:"10px",fontWeight:"bold",borderRadius:"50%"}} >{movie.vote_average} <sup style={{fontSize:"16px",color:"orange"}}>*</sup></Typography>
                </Grid>
              </Grid>
            )
          })
